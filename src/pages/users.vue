  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Lslay Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Lslay adheres to a zero-tolerance policy for any form of child
        ...
        violate the Lslay Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Lslay.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Lslay uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Lslay.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Lslay will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Lslay may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Lslay educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Lslay, we
      ...
      <section class="csp-section">
        ...
        <p>
          Lslay is committed to continuously evaluating and improving its
