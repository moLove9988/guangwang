<template>
  <div class="csp-wrapper">
    <div class="csp-container">
      ...
      <p class="csp-intro">
        Ariny adheres to a zero-tolerance policy for any form of child
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Ariny.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Ariny uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Ariny.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Ariny will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Ariny may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Ariny educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Ariny, we
      ...
      <section class="csp-section">
        ...
        <p>
          Ariny is committed to continuously evaluating and improving its
