  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Pawlia Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Pawlia adheres to a zero-tolerance policy for any form of child
        ...
        violate the Pawlia Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Pawlia.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Pawlia uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Pawlia.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Pawlia will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Pawlia may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Pawlia educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Pawlia, we
      ...
      <section class="csp-section">
        ...
        <p>
          Pawlia is committed to continuously evaluating and improving its
