...
<template>
  <div class="csp-wrapper">
    <div class="csp-container">
      ...
      <p class="csp-intro">
        These terms govern your use of Mayoi, a personal diary and
      ...
      <section class="csp-section">
        ...
        <p>
          By accessing or using Mayoi, you agree to this User Agreement and
          our Privacy Policy. If you do not agree, you should not use Mayoi.
      ...
      <section class="csp-section">
        <h2>2. What Mayoi provides</h2>
        <p>
          Mayoi lets you create diary entries with text, images, or short
        ...
        <p>
          Mayoi is designed for personal diary writing, everyday
      ...
      <section class="csp-section">
        ...
        <ul>
          ...
          <li>
            You must be old enough to use Mayoi under applicable law and
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          to Mayoi. You should only upload or share content that you have
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Using Mayoi for fraud, illegal activity, harassment, abuse, or impersonation.</li>
          ...
          <li>Interfering with Mayoi's security, availability, or normal operation.</li>
          <li>
            Presenting Mayoi content as medical advice, therapy, diagnosis,
      ...
      <section class="csp-section">
        ...
        <p>
          Mayoi has zero tolerance for child sexual abuse and exploitation
      ...
      <section class="csp-section">
        ...
        <p>
          Mayoi may include personal feelings, moods, habits, and everyday
          emotional snapshots shared by users. This content is for personal
          expression and community connection only. Mayoi does not provide
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          to time. We try to keep Mayoi available, but we do not guarantee
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          other action needed to protect Mayoi, users, or the public.
      ...
      <section class="csp-section">
        ...
        <p>
          Mayoi is provided on an "as is" and "as available" basis. Diary
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          as required by applicable law. Continued use of Mayoi after an
      ...
      <section class="csp-section">
        ...
        <address class="csp-address">
          Contact email:
          <a href="mailto:luoenhui1970211@icloud.com?subject=User%20Agreement%20question">
