  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Tori Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Tori adheres to a zero-tolerance policy for any form of child
        ...
        violate the Tori Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Tori.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Tori uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Tori.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Tori will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Tori may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Tori educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Tori, we
      ...
      <section class="csp-section">
        ...
        <p>
          Tori is committed to continuously evaluating and improving its
