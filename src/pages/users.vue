  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Zygoo Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Zygoo adheres to a zero-tolerance policy for any form of child
        ...
        violate the Zygoo Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Zygoo.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Zygoo uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Zygoo.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Zygoo will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Zygoo may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Zygoo educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Zygoo, we
      ...
      <section class="csp-section">
        ...
        <p>
          Zygoo is committed to continuously evaluating and improving its
