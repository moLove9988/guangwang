  ...
  <div class="csp-wrapper">
    <div class="csp-container">
      <header class="csp-header">
        <h1>Fasya Policy Agreement</h1>
        <p class="csp-updated">Last updated: June 25, 2025</p>
      </header>

      <p class="csp-intro">
        Fasya adheres to a zero-tolerance policy for any form of child
        ...
        violate the Fasya Policy will have their accounts
      ...
      <section class="csp-section">
        ...
        <ul>
          <li>Users must be at least 18 years old to use Fasya.</li>
          <li>
      ...
      <section class="csp-section">
        ...
        <p>
          Fasya uses both automated and manual systems to detect underage
      ...
      <section class="csp-section">
        ...
        <p>
          ...
          trafficking) are strictly prohibited from using Fasya.
        </p>
      </section>
      ...
      <section class="csp-section">
        ...
        <p>
          Fasya will strictly enforce the Child Safety Policy, and any
          violations will result in immediate penalties. Depending on the
          severity of the violation, Fasya may cooperate with law
      ...
      <section class="csp-section">
        ...
        <p>Fasya educates users about child safety through the following methods:</p>
        <ul>
      ...
      <section class="csp-section">
        ...
        <p>
          If you encounter child exploitation or abuse outside of Fasya, we
      ...
      <section class="csp-section">
        ...
        <p>
          Fasya is committed to continuously evaluating and improving its
